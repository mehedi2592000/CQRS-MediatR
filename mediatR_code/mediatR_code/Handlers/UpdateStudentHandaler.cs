...
{
    public class UpdateStudentHandaler: IRequestHandler<UpdateStudentCommands, int>
    {
        private readonly IStudentRepository _studentRepository;

        public UpdateStudentHandaler(IStudentRepository studentRepository)
        {
            _studentRepository = studentRepository;
        }
        public async Task<int> Handle(UpdateStudentCommands command, CancellationToken cancellationToken)
        {
